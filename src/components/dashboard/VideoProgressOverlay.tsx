 ...
 */
export function VideoProgressOverlay({ status, errorMessage, address }: VideoProgressOverlayProps) {
      ...
      <div className="absolute inset-0 flex flex-col bg-black/70 z-20 pointer-events-none">
        ...
        {address && (
          <div className="p-3 bg-gradient-to-b from-black/50 to-transparent">
            <p className="text-xs font-medium text-white/80 truncate">{address}</p>
          </div>
        )}
